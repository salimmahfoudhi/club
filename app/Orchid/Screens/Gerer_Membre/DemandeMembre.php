...
class DemandeMembre extends Screen
{
    /**
     * Display header name.
     *
     * @var string
     */
    public $name = 'Nouveau Membre du club';
     ...
     * @var string|null
     */
    public $description = 'Demande de joindre un club';
	...
	public function remove(Clubetudiant $clubetudiants)
    {
        ...
        return redirect()->route('platform.demandemembre');
    }
